...
qué area de la Programación con Python desea ejercitar. Si el alumno es capaz de resolver por sus propios medios y sin asistencia externa los
desafíos de un eje, entonces será capaz de aprobar sin problemas las evaluaciones continuas que se realizan para verificar su evolución.

### La estructura

El repositorio estará dividido en distintas carpetas que correspondan a los ejes que se pueden trabajar. Cada alumno puede hacer pull del repo cada vez
que se actualice para seguir trabajando en él. 
